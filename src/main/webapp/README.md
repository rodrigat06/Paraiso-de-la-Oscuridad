...
- `artistas/jazmin-bean/`: biografia, albumes, EPs, singles, imagenes y audios de Jazmin Bean.
- `artistas/melanie-martinez/`: biografia, albumes, EPs, singles, imagenes y audios de Melanie Martinez.
