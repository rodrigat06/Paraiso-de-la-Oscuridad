// Esta pagina pinta Melanie desde el mismo sistema que usa el administrador.
const artist = window.artistStore.findArtist("melanie-martinez");
const prefix = "../../";
...
setImage(document.querySelector(".portrait"), artist.cover);
