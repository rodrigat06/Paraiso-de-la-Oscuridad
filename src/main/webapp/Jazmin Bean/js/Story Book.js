...
function obtenerPáginaIzquierdaVisual() {
...
function actualizarPáginaIzquierda() {

    const pagina = obtenerPáginaIzquierdaVisual();
...
if (tituloPágina.includes("portals")) {
    totalPages = 20; // Ajusta segÃºn el nÃºmero de pÃ¡ginas de tu libro Portals
...
// ============================================================
// HADES - CONFIGURACIÃ“N ESPECÃFICA
// ============================================================
if (tituloPágina.includes("hades")) {
    totalPages = 19; 
    ...
    mapaCanciones = {
        ...
        "uncanny valley": 16,
        "the vatican": 17,
        "hell's front porch": 18, // Página 16 en el nÃºmero de pÃ¡gina visual
        "chatroom": 19,            // Página 17 en el nÃºmero de pÃ¡gina visual
        "the last two people on earth": 20, // Página 18
        "fin": 21,
...
// ============================================================
// IR DIRECTAMENTE A UNA PÃGINA
// ============================================================

function irAPáginaDirecto(destino) {
...
function Ejecutar() {
    ...
    // ========================================================
        ...
        alert(
            "Esa canciÃ³n no existe en este Ã¡lbum."
        );
    }
}
...
function reproducirMusica(idAudio) {
    ...
    // Si el sonido ya se estÃ¡ reproduciendo, lo pausa. 
    // Si no, lo reproduce.
    if (sonido.paused) {
        sonido.play();
...
function abrirPelicula() {
    ...
    // Intentar reproducir automÃ¡ticamente al abrir
    if (video) {
        video.play();
    }
}
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (portal && contenido) {
        portal.onclick = function() {
            ...
            /*
            // 1. Iniciamos la explosiÃ³n de luz
            portal.classList.add('portal-animacion-entrada');

            // 2. Revelamos la interfaz (botones, libro, etc)
            setTimeout(() => {
                contenido.classList.add('interfaz-visible');
            }, 500); // Empieza a aparecer a mitad de la transiciÃ³n
